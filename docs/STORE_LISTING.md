...
The screenshots in `docs/screenshots/` are the canonical assets for both the
...
3. `end-of-batch.png` — **Give every feed a visible ending.** Load another
   finite batch only after reaching the inline boundary and holding the button.

These images use representative, non-platform content. They avoid account
details and third-party posts while showing the extension's current interface.
